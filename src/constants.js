...
export const SET_NEW_SEARCH_PARAMS = "SET_NEW_SEARCH_PARAMS";
export const SET_NEW_LIST_PRODUCT = "SET_NEW_LIST_PRODUCT";
export const GET_START_PAGE = "GET_START_PAGE";
export const CHECK_CONTROL_STATE = "CHECK_CONTROL_STATE";
export const SET_TYPE_ALL = "SET_TYPE_ALL";
...
export const MIN_VIEW_SHOP = 12;
export const AVERAGE_VIEW_SHOP = 24;
export const MAX_VIEW_SHOP = 48;
